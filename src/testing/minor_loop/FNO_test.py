...
preds_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../results/preds/FNO/minor_loop/'))
...
plt.savefig('Minor_FNO_preds.png', bbox_inches='tight', dpi=300)
...
# Save the figure with a 1:1 aspect ratio
plt.savefig('Minor_FNO_ref.png', bbox_inches='tight', dpi=300)
...
# Save the figure with a 1:1 aspect ratio
plt.savefig('Minor_FNO_error.png', bbox_inches='tight', dpi=300)
