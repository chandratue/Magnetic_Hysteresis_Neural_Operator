...
# Model
model_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../results/trained_models/LSTM/minor_loop/'))
model_save_path = os.path.join(model_dir, 'trained_model.pth')

# saving pred and errors
preds_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../results/preds/LSTM/minor_loop/'))
...
ax.set_title('Preds. LSTM', fontsize=25)
...
plt.savefig('Minor_LSTM_preds.png', bbox_inches='tight', dpi=300)
...
# Save the figure with a 1:1 aspect ratio
plt.savefig('Minor_LSTM_ref.png', bbox_inches='tight', dpi=300)
...
# Set title and labels with specific font sizes
ax.set_title('Error LSTM', fontsize=25)
ax.set_xlabel('$t$ [s]', fontsize=25)
ax.set_ylabel('$B$ [T]', fontsize=25)
...
# Save the figure with a 1:1 aspect ratio
plt.savefig('Minor_LSTM_error.png', bbox_inches='tight', dpi=300)
