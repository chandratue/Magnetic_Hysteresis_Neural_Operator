...
# Model
model_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../results/trained_models/LSTM/FORC/'))
model_save_path = os.path.join(model_dir, 'trained_model.pth')

# saving pred and errors
preds_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../results/preds/LSTM/FORC/'))
...
plt.savefig('FORC_LSTM_preds.png', bbox_inches='tight', dpi=300)
...
# Save the figure with a 1:1 aspect ratio
plt.savefig('FORC_LSTM_ref.png', bbox_inches='tight', dpi=300)
...
# Save the figure with a 1:1 aspect ratio
plt.savefig('FORC_LSTM_error.png', bbox_inches='tight', dpi=300)
