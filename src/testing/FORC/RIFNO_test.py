...
preds_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../results/preds/RIFNO/FORC/'))
...
plt.savefig('FORC_RIFNO_preds.png', bbox_inches='tight', dpi=300)
...
# Save the figure with a 1:1 aspect ratio
plt.savefig('FORC_RIFNO_ref.png', bbox_inches='tight', dpi=300)
...
# Save the figure with a 1:1 aspect ratio
plt.savefig('FORC_RIFNO_error.png', bbox_inches='tight', dpi=300)
