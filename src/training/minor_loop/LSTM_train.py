...
# Loss
loss_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../results/logs/LSTM/minor_loop/'))
...
torch.save({'model_state_dict': lstm.state_dict()}, model_save_path)
